...
import lk.gov.health.data.MonthEndRecord;
import lk.gov.health.data.Sex;
import lk.gov.health.data.dataStructure.WeekDayWork;
import lk.gov.health.data.hr.DayType;
import lk.gov.health.data.hr.DepartmentAttendance;
import lk.gov.health.data.hr.FingerPrintRecordType;
import lk.gov.health.data.hr.LeaveType;
import lk.gov.health.data.hr.PaysheetComponentType;
import lk.gov.health.data.hr.ReportKeyWord;
import lk.gov.health.data.hr.StaffLeaveBallance;
import lk.gov.health.data.hr.StaffShiftAggrgation;
import lk.gov.health.ejb.CommonFunctions;
import lk.gov.health.ejb.FinalVariables;
import lk.gov.health.ejb.HumanResourceBean;
import lk.gov.health.entity.Consultant;
import lk.gov.health.entity.Department;
import lk.gov.health.entity.Form;
...
import lk.gov.health.entity.hr.SalaryCycle;
import lk.gov.health.entity.hr.Shift;
import lk.gov.health.entity.hr.StaffLeave;
import lk.gov.health.entity.hr.StaffPaysheetComponent;
import lk.gov.health.entity.hr.StaffSalary;
import lk.gov.health.entity.hr.StaffSalaryComponant;
import lk.gov.health.entity.hr.StaffShift;
import lk.gov.health.entity.hr.StaffShiftExtra;
import lk.gov.health.entity.hr.StaffShiftHistory;
import lk.gov.health.facade.DepartmentFacade;
import lk.gov.health.facade.FingerPrintRecordFacade;
import lk.gov.health.facade.FingerPrintRecordHistoryFacade;
import lk.gov.health.facade.FormFacade;
import lk.gov.health.facade.InstitutionFacade;
import lk.gov.health.facade.ShiftFacade;
import lk.gov.health.facade.StaffFacade;
import lk.gov.health.facade.StaffLeaveFacade;
import lk.gov.health.facade.StaffPaysheetComponentFacade;
import lk.gov.health.facade.StaffSalaryComponantFacade;
import lk.gov.health.facade.StaffSalaryFacade;
import lk.gov.health.facade.StaffShiftFacade;
import lk.gov.health.facade.StaffShiftHistoryFacade;
...
//    }
    ...
    public void createStaffLeaveAggregate() {
        ...
        String sql = "";
        HashMap hm = new HashMap();
        sql = "select new lk.gov.health.data.hr.StaffLeaveBallance(ss.staff,ss.leaveType,sum(ss.qty)) "
                + " from StaffLeave ss "
                + " where ss.retired=false "
                + " and ss.leaveDate between :frm  and :to ";
        hm.put("frm", fromDate);
    ...
    public void createStaffAttendanceAggregate() {
        ...
        HashMap hm = new HashMap();
        sql = "select new lk.gov.health.data.hr.DepartmentAttendance(ss.staff.workingDepartment,"
...
//        
    ...
    public void createStaffWorkingTime() {
        ...
        HashMap hm = new HashMap();
        sql = "select new lk.gov.health.data.hr.StaffShiftAggrgation(ss.staff,"
