...
import lk.gov.health.bean.pharmacy.DealerController;
import lk.gov.health.data.BillType;
import lk.gov.health.data.DepartmentType;
import lk.gov.health.data.dataStructure.PharmacyStockRow;
import lk.gov.health.data.dataStructure.StockReportRecord;
...
public class StoreReportsStock implements Serializable {
    ...
    public void fillDepartmentNonEmptyItemStocks() {
        ...
        Map m = new HashMap();
        String sql;
        sql = "select new lk.gov.health.data.dataStructure.PharmacyStockRow"
