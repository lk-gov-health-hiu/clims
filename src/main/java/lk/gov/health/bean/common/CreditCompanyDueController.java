...
import lk.gov.health.data.dataStructure.DealerDueDetailRow;
import lk.gov.health.data.dataStructure.InstitutionBills;
import lk.gov.health.data.dataStructure.InstitutionEncounters;
import lk.gov.health.data.table.String1Value5;
import lk.gov.health.ejb.CommonFunctions;
import lk.gov.health.ejb.CreditBean;
...
import lk.gov.health.facade.AdmissionFacade;
...
//                newIns.setPaidTotal(newIns.getPaidTotal() + b.getCreditPaidAmount());
                b.getFinalBill().setNetTotal(lk.gov.health.java.CommonFunctions.round(b.getFinalBill().getNetTotal()));
                b.setCreditPaidAmount(Math.abs(b.getCreditPaidAmount()));
                b.setCreditPaidAmount(lk.gov.health.java.CommonFunctions.round(b.getCreditPaidAmount()));
                b.getFinalBill().setPaidAmount(lk.gov.health.java.CommonFunctions.round(b.getFinalBill().getPaidAmount()));
                b.setTransPaid(b.getFinalBill().getPaidAmount()+b.getCreditPaidAmount());
                //System.out.println("b.getTransPaid() = " + b.getTransPaid());
                b.setTransPaid(lk.gov.health.java.CommonFunctions.round(b.getTransPaid()));
...
//                newIns.setPaidTotal(newIns.getPaidTotal() + (Math.abs(b.getCreditPaidAmount()) + Math.abs(b.getFinalBill().getPaidAmount())));
            ...
            newIns.setTotal(lk.gov.health.java.CommonFunctions.round(newIns.getTotal()));
            newIns.setPaidTotal(lk.gov.health.java.CommonFunctions.round(newIns.getPaidTotal()));
            institutionEncounters.add(newIns);
        }
