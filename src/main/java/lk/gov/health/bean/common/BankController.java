...
public class BankController implements Serializable {
    ...
    public List<Institution> getSelectedItems() {
        selectedItems = getFacade().findBySQL("select c from Institution c where c.retired=false and i.institutionType = lk.gov.health.data.InstitutionType.Bank and upper(c.name) like '%" + getSelectText().toUpperCase() + "%' order by c.name");
    ...
    public List<Institution> getItems() {
        if (items == null) {
            String sql = "SELECT i FROM Institution i where i.retired=false and i.institutionType = lk.gov.health.data.InstitutionType.Bank order by i.name";
