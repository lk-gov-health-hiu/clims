...
import lk.gov.health.bean.common.DepartmentController;
...
import static lk.gov.health.data.DepartmentListMethod.ActiveDepartmentsOfAllInstitutions;
import static lk.gov.health.data.DepartmentListMethod.ActiveDepartmentsOfLoggedInstitution;
import static lk.gov.health.data.DepartmentListMethod.AllDepartmentsOfAllInstitutions;
import static lk.gov.health.data.DepartmentListMethod.AllDepartmentsOfLoggedInstitution;
import static lk.gov.health.data.DepartmentListMethod.AllPharmaciesOfAllInstitutions;
import static lk.gov.health.data.DepartmentListMethod.AllPharmaciesOfLoggedInstitution;
import static lk.gov.health.data.DepartmentListMethod.LoggedDepartmentOnly;
import lk.gov.health.data.DepartmentType;
import lk.gov.health.data.dataStructure.ItemReorders;
import lk.gov.health.data.dataStructure.ItemTransactionSummeryRow;
...
import lk.gov.health.facade.ReorderFacade;
...
//        dateModel.getAxes().put(AxisType.X, axis);
    ...
    public List<ItemTransactionSummeryRow> findDailyStockAverage(Item item, Department dept, Date fd, Date td) {
        String jpql;
        List<ItemTransactionSummeryRow> rows;
        jpql = "SELECT new lk.gov.health.data.dataStructure.ItemTransactionSummeryRow"
    ...
    public List<ItemTransactionSummeryRow> findDailyTransactions(Item item, Department dept, Date fd, Date td, List<BillType> billTypes) {
        ...
        jpql = "SELECT new lk.gov.health.data.dataStructure.ItemTransactionSummeryRow(s.item, sum(s.qty), FUNC('DATE',s.bill.createdAt)) "
                + " FROM BillItem s "
