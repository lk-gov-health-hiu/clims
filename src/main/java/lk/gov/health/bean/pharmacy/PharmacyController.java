...
import lk.gov.health.data.dataStructure.DepartmentSale;
import lk.gov.health.data.dataStructure.DepartmentStock;
import lk.gov.health.data.dataStructure.InstitutionSale;
import lk.gov.health.data.dataStructure.InstitutionStock;
import lk.gov.health.data.dataStructure.ItemQuantityAndValues;
import lk.gov.health.data.dataStructure.ItemTransactionSummeryRow;
import lk.gov.health.data.dataStructure.StockAverage;
...
//        //System.out.println("m = " + m);
    ...
    public List<ItemQuantityAndValues> findPharmacyTrnasactionQuantityAndValues(Date fromDate,
        ...
        m.put("to", getToDate());
        sql = "select new lk.gov.health.data.dataStructure.ItemQuantityAndValues(i.item, "
