...
import lk.gov.health.entity.PersonInstitution;
...
import lk.gov.health.facade.PersonInstitutionFacade;
...
//        }
    ...
    public void createWithCreditbyDepartmentBilled() {
        ...
        if (department == null) {
            lk.gov.health.facade.util.JsfUtil.addErrorMessage("Please Select Deparment");
            return;
        }
