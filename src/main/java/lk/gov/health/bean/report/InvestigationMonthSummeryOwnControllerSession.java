...
import lk.gov.health.data.dataStructure.InvestigationSummeryData;
import lk.gov.health.data.dataStructure.ItemInstitutionCollectingCentreCountRow;
...
//        }
    ...
    public void createIxCountByInstitutionAndCollectingCentreOld() {
        ...
        jpql = "Select new lk.gov.health.data.dataStructure.ItemInstitutionCollectingCentreCountRow(bi.item, count(bi), bi.bill.institution, bi.bill.collectingCentre) "
                + " from BillItem bi "
                + " join bi.bill b "
        ...
        m = new HashMap();
        jpql = "Select new lk.gov.health.data.dataStructure.ItemInstitutionCollectingCentreCountRow(bi.item, count(bi), bi.bill.institution) "
                + " from BillItem bi "
                + " join bi.bill b "
                + " join b.institution ins "
                + " join bi.item item "
...
//        countTotal = billed - (refunded + cancelled);
    ...
    private void setCountTotalWithoutC(InvestigationSummeryData is, Item w) {
        ...
        temMap.put("ixtype", lk.gov.health.entity.lab.Investigation.class);
