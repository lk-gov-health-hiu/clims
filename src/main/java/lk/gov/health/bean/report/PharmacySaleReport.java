...
import lk.gov.health.data.dataStructure.DatedBills;
import lk.gov.health.data.dataStructure.PharmacyDetail;
import lk.gov.health.data.dataStructure.PharmacyPaymetMethodSummery;
import lk.gov.health.data.dataStructure.PharmacySummery;
import lk.gov.health.data.dataStructure.SearchKeyword;
import lk.gov.health.data.table.String1Value3;
import lk.gov.health.data.table.String1Value6;
import lk.gov.health.data.table.String2Value4;
import lk.gov.health.ejb.BillReportBean;
