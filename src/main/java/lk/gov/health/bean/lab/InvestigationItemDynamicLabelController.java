...
public class InvestigationItemDynamicLabelController implements Serializable {
    ...
    public List<InvestigationItem> getInvestigationItemsOfDynamicLabelType() {
        if (investigation != null) {
            investigationItemsOfDynamicLabelType = getInvestigationItemFacade().findBySQL("select i from InvestigationItem i where i.retired=false and i.item.id = " + investigation.getId() + " and i.ixItemType = lk.gov.health.data.InvestigationItemType.DynamicLabel");
        }
