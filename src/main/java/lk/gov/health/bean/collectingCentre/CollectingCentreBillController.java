 ...
 */
package lk.gov.health.bean.collectingCentre;

import lk.gov.health.bean.channel.AgentReferenceBookController;
import lk.gov.health.bean.channel.ChannelBillController;
import lk.gov.health.bean.common.*;
...
import lk.gov.health.data.dataStructure.BillListWithTotals;
import lk.gov.health.data.dataStructure.PaymentMethodData;
import lk.gov.health.data.dataStructure.YearMonthDay;
import lk.gov.health.ejb.BillEjb;
...
//        //System.out.println(" Error find Number CheckTime 3 = " + new Date());
    ...
    private boolean errorCheck() {
        ...
        if (getPatientTabId().equals("tabSearchPt")) {
            ...
            if (!lk.gov.health.java.CommonFunctions.checkAgeSex(getNewPatient().getPerson().getDob(), getNewPatient().getPerson().getSex(), getNewPatient().getPerson().getTitle())) {
