 ...
 */
package lk.gov.health.bean.channel;
...
import lk.gov.health.data.DoctorDayChannelCount;
import lk.gov.health.data.FeeType;
import lk.gov.health.data.HistoryType;
import lk.gov.health.data.PaymentMethod;
import lk.gov.health.data.PersonInstitutionType;
import lk.gov.health.data.WeekdayDisplay;
import lk.gov.health.data.channel.DateEnum;
import lk.gov.health.data.channel.PaymentEnum;
import lk.gov.health.data.dataStructure.BillsTotals;
import lk.gov.health.data.dataStructure.ChannelDoctor;
import lk.gov.health.data.dataStructure.WebUserBillsTotal;
import lk.gov.health.data.hr.ReportKeyWord;
import lk.gov.health.data.table.String1Value1;
import lk.gov.health.data.table.String1Value3;
import lk.gov.health.ejb.ChannelBean;
import lk.gov.health.ejb.CommonFunctions;
import lk.gov.health.entity.AgentHistory;
...
import lk.gov.health.entity.channel.ArrivalRecord;
import lk.gov.health.facade.AgentHistoryFacade;
import lk.gov.health.facade.ArrivalRecordFacade;
...
import lk.gov.health.facade.BillSessionFacade;
...
//                //System.out.println("b = " + b.getBillClass());
    ...
    public void createDailyDoctorAnalysis() {
        HashMap m = new HashMap();
        String sql;
        sql = "Select new lk.gov.health.data.DoctorDayChannelCount(bs.bill.staff, bs.sessionDate , count(bs) )"
                + " From BillSession bs "
                + " where bs.bill.staff is not null "
                + " and bs.retired=false "
