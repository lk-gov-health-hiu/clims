...
public class CommonFunctions {
    ...
    public DateRange getDateRangeForOT(Date date) {
        ...
        Date startOfThisMonth = lk.gov.health.java.CommonFunctions.getStartOfMonth(date);
        Calendar cal = Calendar.getInstance();
        cal.setTime(startOfThisMonth);
        cal.add(Calendar.DAY_OF_WEEK, -1);
        Date startOfPrevMonth = lk.gov.health.java.CommonFunctions.getStartOfMonth(cal.getTime());
        Date from = getFirstDayOfWeek(startOfPrevMonth);
        Date endOfPrevMonth = lk.gov.health.java.CommonFunctions.getEndOfMonth(cal.getTime());
