...
import lk.gov.health.data.dataStructure.DateRange;
import lk.gov.health.data.dataStructure.ExtraDutyCount;
import lk.gov.health.data.hr.DateType;
...
import lk.gov.health.entity.hr.HrForm;
import lk.gov.health.entity.hr.PaysheetComponent;
import lk.gov.health.entity.hr.PhDate;
...
import lk.gov.health.entity.hr.StaffLeaveEntitle;
import lk.gov.health.entity.hr.StaffLeaveSystem;
...
import lk.gov.health.facade.PaysheetComponentFacade;
import lk.gov.health.facade.PhDateFacade;
import lk.gov.health.facade.ShiftFacade;
import lk.gov.health.facade.StaffFacade;
import lk.gov.health.facade.StaffLeaveEntitleFacade;
...
//            System.err.println("SETTING SALARY TRUE");
    ...
    public List<ExtraDutyCount> calExtraDuty(Date date, Staff staff) {
        ...
        dateRange.setFromDate(lk.gov.health.java.CommonFunctions.getStartOfMonth(date));
        dateRange.setToDate(lk.gov.health.java.CommonFunctions.getEndOfMonth(date));
