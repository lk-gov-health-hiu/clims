...
import lk.gov.health.data.CssOverflow;
import lk.gov.health.data.CssPosition;
...
import lk.gov.health.data.lab.DataEntryMethod;
...
public class ReportItem implements Serializable {
    ...
    public String toString() {
        return "lk.gov.health.entity.ReportItem[ id=" + id + " ]";
    }
